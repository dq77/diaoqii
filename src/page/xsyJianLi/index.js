  ...
  render () {
    ...
    return (
      <div className="jianLiPage">
        <Carousel className="jianLiCarousel"
          vertical
          dots={false}
        >
          <div className="item" style={{height: clientHeight-20}}>
          ...
          <div className="item item-skill" style={{height: clientHeight-20}}>
            <div className="content">
          ...
          <div className="item item-exprience" style={{height: clientHeight-20}}>
            <div className="content">
          ...
          <div className="item item-person" style={{height: clientHeight-20}}>
            <div className="content">
